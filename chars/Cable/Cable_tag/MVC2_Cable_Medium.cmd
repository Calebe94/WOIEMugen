...
triggerall = (Var(26) = 2) && (partner, life > 0) && (partner, stateno = 4714)
...
triggerall = (Var(26) = 2) && (partner, life > 0) && (power >= 2000)
trigger1 = (StateType != A) && (Ctrl = 1)
...
v = 53 ;Tag AI Activation Variable
value = 1 

[State -1, TagINCheck1] ;energy depleted by a third, tag in partner? (Only if partner has more life) (20%) chance
type = ChangeState
value = 4712
triggerall = (partner, stateno = 4714) && (var(53) = 1) && (statetype != A) && (movetype != H) && (statetype != L) && (P2life != 0)
trigger1 =  (life < 700) && (partner, life > 750) && (ctrl = 1) && (random <= 700) ;Taking some damage
trigger2 =  (life < 400) && (partner, life > 450)  && (ctrl = 1) && (random <= 500) ;In the middle
trigger3 =  (life < 150) && (partner, life > 400)  && (ctrl = 1) && (random <= 300) ;Life is really low
persistent = 0

[State -1, PerformAssist] ;call in partner for an assist? (10%) chance
type = ChangeState
value = 4716
triggerall = (var(53) = 1) && (statetype != A) && (movetype != H) && (statetype != L) && (P2life != 0) && (partner, life > 0) && (partner, stateno = 4714)
trigger1 =  (ctrl = 1) && (partner, life > 100) && (random >= 990)
persistent = 0

[State -1, PerformDualHyper] ;call in partner for a dual hyper? (10%) chance
type = ChangeState
value = 4718
triggerall = (var(53) = 1) && (statetype != A) && (movetype != H) && (statetype != L) && (P2life != 0) && (partner, life > 0) && (power >= 2000) && (partner, stateno = 4714)
trigger1 =  (ctrl = 1) && (random >= 990)
persistent = 0

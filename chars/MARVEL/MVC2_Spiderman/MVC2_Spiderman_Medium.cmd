...
triggerall = statetype = A
triggerall = movecontact
trigger1 = stateno = 600 || stateno = 590
...
triggerall = Var(59)
triggerall = movehit
trigger1 = stateno = 210 || NumTarget(320) || stateno = 521
...
triggerall =  -100 <= p2bodydist y <= -60+var(7)
;triggerall = p2bodydist y = [-5,5]
trigger1 = p2movetype != A  && p2statetype != L ; && p2statetype != A
trigger1 = ctrl
trigger1 = random < 200
...
;triggerall =  -70 - 40*(P2bodydist X < 30) <= p2bodydist y <= -70+var(7) - 40*(P2bodydist X < 30)
triggerall =  -60 <= p2bodydist y <= -60+var(7)
...
trigger5 = (stateno = 510 || stateno = 420) && MoveHit && random < 300
...
trigger1 = p2movetype != A
trigger1 = p2statetype != L && ctrl  ;&& p2movetype = H
trigger2 = var(17) = 1 && random < 100
trigger3 = var(17) = 2 && random < 200
trigger4 = var(17) = 3 && var(21) = var(36)
...
[State -1, Web Ball]
type = ChangeState
value = 1450 + 10*(P2BodyDist X = [150,200]) + 10*(P2BodyDist X = [201,320])
...
[State -1, Web Ball]
type = ChangeState
value = 1451+10*(random%3)
triggerall = var(59) && !NumHelper(21450) && (stateno != [7720,7721])
triggerall = statetype = A
;triggerall = p2statetype != L; && enemynear,vel y >= 0
triggerall = p2bodydist X = [50,320]
triggerall = p2bodydist Y = [40,360]
;triggerall = var(8) = [25,360]
...
triggerall = p2bodydist X = [90,320]
;triggerall = p2bodydist Y = [-5,5]
triggerall =  -30 <= p2bodydist y <= -50+var(7)
triggerall = random < 100
trigger1 = ctrl
trigger2 = var(17) = 3
trigger3 = var(9)
...
;triggerall = p2statetype != L; && enemynear,vel y >= 0
triggerall = p2bodydist X = [90,320]
triggerall = p2bodydist Y = [-360,-90]
;triggerall = var(8) = [25,360]
...
triggerall = p2bodydist Y = [-360,-120]
;triggerall = var(8) = [25,360]
;triggerall = p2bodydist Y/P2bodydist X = [-1.2,-0.7]
;triggerall =  -70 <= p2bodydist y <= -70+var(7)
triggerall = random < 100
...
triggerall = p2bodydist X = [0,70]
triggerall =  -170 <= p2bodydist y <= -70+var(7)
...
type = ChangeState
value = 3010
triggerall = enemynear,life > 300 && BackEdgeDist  >= 0 && !NumHelper(23040) && !NumHelper(21540)
...
;triggerall =  -120 + 200*(StateType = A)<= p2bodydist y <= -40+var(7) +  320*(StateType = A )
...
triggerall = random < 50+100*(MoveHit > 0); + 100*(enemynear,movetype, = H)
...
type = ChangeState
value = 3400
triggerall = enemynear,life > 300 && !NumHelper(23040) && !NumHelper(21540) && BackEdgeDist  >= 0
triggerall = Var(59) && (stateno != [3000,5000]) 
triggerall = power >= 1000
triggerall = statetype != A
triggerall = p2bodydist X = [90,270]
triggerall =  p2bodydist y = [-240,240]
triggerall = random < 50+100*(MoveHit > 0); + 100*(enemynear,movetype, = H)
triggerall = p2statetype != L && p2stateno != 5120
trigger1 = ctrl
trigger2 = random < (var(17)*100)
...
trigger1 = var(8) = [-35,15] ;&& p2statetype = A
trigger1 = random < 400
...
triggerall = var(59)
triggerall = p2bodydist X = [0,50]
triggerall = var(8) = [-35,25];+40*(p2statetype != A)]
...
value = 710
triggerall = var(59)
;triggerall =  -30 <= p2bodydist y <= -30+var(7)
...
value = 620
triggerall = var(59)
triggerall = var(8) = [-25,25];+40*(p2statetype != A)]
triggerall = p2bodydist X = [0,60]
...
value = 720
triggerall = var(59)
triggerall = var(8) = [-35,35+40*(p2statetype != A)]
...
triggerall = !var(59) && !NumHelper(21450)

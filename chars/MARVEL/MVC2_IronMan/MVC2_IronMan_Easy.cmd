...
triggerall = Var(59)
triggerall = movehit
trigger1 = stateno = 320 || stateno = 410
...
[State -1, Throw]
type = ChangeState
value = ifelse(random < 300,800,830)
triggerall = var(59)
...
;---------------------------------------------------------------------------
[State -1,AI standing light punch 2]
type = ChangeState
value = 201
triggerall = var(59)
triggerall = p2bodydist X = [0,50]
...
trigger3 = stateno != 410
trigger4 = var(17) = 5 && stateno = 52 && random < 200
trigger5 = stateno = 510 && MoveHit && random < 200
...
triggerall =  -130 <= p2bodydist y <= -80+var(7)
...
;trigger5 = (stateno = 210 || stateno = 410) && MoveHit && random < 200
...
triggerall = p2bodydist X = [0,100]
;triggerall = p2bodydist y = [-5,5]
triggerall =  -80 <= p2bodydist y <= -20+var(7)
...
triggerall = var(59)
triggerall = statetype != A
triggerall = p2bodydist X = [80,270]
triggerall =  -60 <= p2bodydist y <= -60+var(7)
;triggerall = p2bodydist y = [-120,5]
trigger1 = p2movetype != A
trigger1 = p2statetype != L && ctrl  && random < 100 -50*(prevstateno = 420);&& p2movetype = H
trigger2 = var(17) = 1 && random < 100
trigger3 = var(17) = 2 && random < 200
trigger4 = var(17) = 3 && var(21) = var(36)
...
triggerall =  -80 <= p2bodydist y <= -80+var(7)
triggerall = random < 100-50*(prevstateno = [1240,1250])
trigger1 = ctrl
trigger2 = var(17) = 3
trigger3 = var(9)
...
type = ChangeState
value = 1270+10*(random%2)
triggerall = var(59)
triggerall = statetype != A
triggerall = p2statetype != L
triggerall = p2bodydist X = [70,150]
triggerall = p2bodydist Y = [-130,5]
;triggerall =  -75 <= p2bodydist y <= -75+var(7)
triggerall = random < 100-50*(prevstateno = [1270,1290])
trigger1 = ctrl
trigger2 = var(17) = 3
trigger3 = var(9)
...
;triggerall =  -60 <= p2bodydist y <= -60+var(7)
triggerall = random < 100-50*(prevstateno = [1450,1480])
trigger1 = ctrl
trigger2 = var(17) = 3
trigger3 = var(9)
...
triggerall = p2bodydist Y > 80;= [340,5]
;triggerall = p2bodydist Y/p2bodydist X = [-1.3,-0.7]
;triggerall =  -60 <= p2bodydist y <= -60+var(7)
triggerall = random < 100-50*(prevstateno = [1450,1480])
trigger1 = ctrl
...
[State -1, Land Mine]
type = ChangeState
value = 1480+10*(p2bodydist x = [100,170]) + 10*(p2bodydist x = [171,270])
triggerall = var(59) && NumHelper(21482) = 0
triggerall = statetype != A
triggerall = p2statetype != L
...
;triggerall = p2bodydist Y/p2bodydist X = [-1.3,-0.7]
;triggerall =  -60 <= p2bodydist y <= -60+var(7)
triggerall = random < 100-50*(prevstateno = [1480,1500])
trigger1 = ctrl
trigger2 = var(17) = 3
trigger3 = var(9)
...
type = ChangeState
value = 1480+10*(p2bodydist x = [100,170]) + 10*(p2bodydist x = [171,270])
triggerall = var(59) && NumHelper(21482) = 0 && (stateno != [7720,7721])
triggerall = statetype = A
triggerall = p2statetype != L
triggerall = p2bodydist X >= 10
triggerall = p2bodydist Y > 80;= [340,5]
...
type = ChangeState
value = 3000
triggerall = enemynear,life > 300 && BackEdgeDist >= 0
triggerall = Var(59) && (stateno != [7720,7721]) && (stateno != [3000,3500]) 
triggerall = power >= 1000 
triggerall = statetype != A
triggerall = p2bodydist X > 100
;triggerall = p2bodydist y = [-5,5]
triggerall =  -150 <= p2bodydist y <= -40+var(7)
triggerall = random < 100
triggerall = p2statetype != L
trigger1 = ctrl
...
[State -1, Hyper Missile]
type = ChangeState
value = 3040
triggerall = enemynear,life > 300 && BackEdgeDist >= 0
triggerall = Var(59) && (stateno != [3000,3500]) 
triggerall = power >= 1000
triggerall = statetype != A
triggerall = p2bodydist X > 100
triggerall =  p2bodydist y = [-5,5]
...
trigger1 = var(8) = [-70,35] ;&& p2statetype = A
trigger1 = random < 400
...
triggerall = var(8) = [-70,35];+40*(p2statetype != A)]
...
;---------------------------------------------------------------------------
[State -1, Air Strong Punch Up]
type = ChangeState
value = 621
triggerall = var(59)
triggerall = var(8) = [-170,-90]
triggerall = p2bodydist X = [0,120]
;trigger1 =  -170 <= p2bodydist y <= -90+var(7)
trigger1 = statetype = A && ctrl && random < 100
trigger2 = var(17) = 5 && random < 200
trigger3 = var(17) = 6 && random < 300
trigger4 = var(17) = 7 && var(21) = var(36)
...
;---------------------------------------------------------------------------
[State -1, Air Strong Punch Down]
type = ChangeState
value = 622
triggerall = var(59)
triggerall = var(8) = [-80,25+50*(p2statetype != A)]
triggerall = p2bodydist X = [0,120]
;trigger1 =  -170 <= p2bodydist y <= -90+var(7)
trigger1 = statetype = A && ctrl && random < 100
trigger2 = var(17) = 5 && random < 200
...
;---------------------------------------------------------------------------
[State -1, Air Strong Kick Down]
type = ChangeState
value = 721
triggerall = var(59) && !var(54)
triggerall = var(8) = [50,250]
triggerall = p2bodydist X = [1,220]
triggerall = p2bodydist Y/p2bodydist X = [0.8,1.2]
;triggerall =  -40 <= p2bodydist y <= -40+var(7)
trigger1 = statetype = A && ctrl && random < 100
trigger2 = var(17) = 5 && random < 200
trigger3 = var(17) = 6 && random < 300
...
;---------------------------------------------------------------------------
[State -1, Air Strong Kick Up]
type = ChangeState
value = 722
triggerall = var(59)
triggerall = var(8) = [-150,-70]
triggerall = p2bodydist X = [0,10]
;triggerall = p2bodydist Y/p2bodydist X = [-1.2,0.5]
triggerall =  -140 <= p2bodydist y <= -80+var(7)
trigger1 = statetype = A && ctrl && random < 100
trigger2 = var(17) = 5 && random < 200
trigger3 = var(17) = 6 && random < 300
trigger4 = var(17) = 7 && var(21) = var(36)
...
value = 3040
triggerall = !var(59) && BackEdgeDist >= 0
triggerall = command = "Hyper Missile"
triggerall = power >= 1000
;triggerall = statetype != A
trigger1 = ctrl
trigger2 = var(51)
...
value = 3080
triggerall = !var(59) && BackEdgeDist >= 0
triggerall = command = "Hyper IronMan"
triggerall = power >= 1000
triggerall = statetype != A
trigger1 = ctrl
trigger2 = var(51)
...
trigger2 = MoveHit
trigger2 = stateno = 320 || stateno = 410

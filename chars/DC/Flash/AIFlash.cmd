...
trigger1 = (p2bodydist X <= 250) && (random <= 899)
value = 130
...
trigger1 = P2BodyDist X > 50 && enemynear, statetype = S && enemynear, numproj = 0 && random = [100,200]
...
trigger1 = P2BodyDist X <= 65 && Random = [250,350]
...
triggerall = StateType != A && MoveType != H && !winko && !IsHelper
triggerall = NumHelper(10) = 0 && NumHelper(25) = 0 && Var(21) = 0
trigger1 = P2BodyDist X <= 70 && (random = [50,100])
...
triggerall = StateType != A && MoveType != H && !winko && !IsHelper
triggerall = NumHelper(10) = 0 && NumHelper(25) = 0 && Var(21) = 0
trigger1 = P2BodyDist X <= 70 && (random = [0,50])
...
triggerall = StateType != A && MoveType != H && !winko && !IsHelper
triggerall = NumHelper(10) = 0 && NumHelper(25) = 0 && Var(21) = 0
trigger1 = P2BodyDist X >= 100 && Random = [400,600]
...
triggerall = StateType != A && MoveType != H && !winko && !IsHelper
triggerall = NumHelper(10) = 0 && NumHelper(25) = 0 && Var(21) = 0
trigger1 = P2BodyDist X >= 100 && Random = [600,800]

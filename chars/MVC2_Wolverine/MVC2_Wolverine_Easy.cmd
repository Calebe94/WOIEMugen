...
triggerall = p2bodydist X = [0,80]
triggerall = p2bodydist y = [-5,5]
;triggerall =  -50 <= p2bodydist y <= -40+var(7)
trigger1 = p2statetype != L && p2statetype != A
...
triggerall =  -70 <= p2bodydist y <= -30+var(7)
;triggerall = p2bodydist y = [-5,5]
trigger1 = p2movetype != A  && p2statetype != L;  && p2statetype != A
trigger1 = ctrl
trigger1 = random < 200
...
;triggerall =  -70 - 40*(P2bodydist X < 30) <= p2bodydist y <= -70+var(7)
...
;triggerall = p2bodydist y = [-5,5]
triggerall =  -100 <= p2bodydist y <= 0+var(7)
...
;---------------------------------------------------------------------------
[State -1, Berserker Barrage]
type = ChangeState
value = 1480 + 60*(random%2)+ 10*(P2BodyDist X = [101,200]) + 10*(P2BodyDist X = [201,320])
...
;---------------------------------------------------------------------------
[State -1, Berserker Slash]
type = null;ChangeState
value = 1540 + 10*(P2BodyDist X = [101,200]) + 10*(P2BodyDist X = [201,320])
triggerall = var(59) ; && (stateno != [7720,7721])
triggerall = statetype != A
triggerall = p2statetype != L; && enemynear,vel y >= 0
triggerall = p2bodydist X = [90,320]
...
triggerall =  -270 <= p2bodydist y <= -10+var(7)
...
triggerall = p2bodydist y = [-340,0]
;triggerall =  -120 + 200*(StateType = A)<= p2bodydist y <= -40+var(7) +  320*(StateType = A )
triggerall = random < 100+100*(MoveHit > 0)
triggerall = p2statetype != L
trigger1 = ctrl
trigger2 = random < (var(17)*100)
trigger3 = var(51) && random < 100+100*(var(9) > 0)
...
[State -1, Berserker Charge]
type = ChangeState
value = 3040
triggerall = enemynear,life > 300 && !var(39)
triggerall = Var(59) && (stateno != [3000,5000]) 
triggerall = power >= 1000
triggerall = statetype != A
triggerall = p2bodydist X = [120,320]
triggerall = p2bodydist y = [-220,5]
triggerall = random < 50;+100*(MoveHit > 0)
triggerall = p2statetype != L && p2stateno != 5120
trigger1 = ctrl
trigger2 = random < (var(17)*100)
...
trigger1 = var(8) = [-25,10] ;&& p2statetype = A
trigger1 = random < 400
...
value = 720
triggerall = var(59)
triggerall = var(8) = [-25,35];+40*(p2statetype != A)]
triggerall = p2bodydist X = [0,70]
;triggerall =  -40 <= p2bodydist y <= -40+var(7)
trigger1 = statetype = A && ctrl && random < 100
trigger2 = var(17) = 5 && random < 200
...
value = 3000
triggerall = !var(59)
triggerall = command = "Berserker Barrage X"
triggerall = power >= 1000
triggerall = statetype != A
trigger1 = ctrl
trigger2 = var(51)
...
type = ChangeState
value = 3040
triggerall = !var(59) && !var(39)
triggerall = command = "Berserker Charge"
triggerall = power >= 1000
triggerall = statetype != A
trigger1 = ctrl
trigger2 = var(51)
...
value = 3120
triggerall = !var(59)
triggerall = command = "Tornado Claw X"
triggerall = power >= 1000
triggerall = statetype != A
trigger1 = ctrl
trigger2 = var(51)
...
value = 3170
triggerall = !var(59)
triggerall = command = "Drill Claw X"
triggerall = power >= 1000
triggerall = statetype != A
trigger1 = ctrl
trigger2 = var(51)
...
;---------------------------------------------------------------------------
[State -1, Standing Medium Punch 2]
type = null;ChangeState
value = 211
triggerall = !var(59)
triggerall = command != "holddown"
...
trigger1 = ctrl
trigger2 = var(17) = 1
trigger3 = var(17) = 2 && var(20) = var(36)+1
trigger3 = (stateno != 410 && stateno != 210)
...
trigger1 = ctrl
trigger2 = var(17) = 5
trigger3 = var(17) = 6 && var(20) = var(36)+1
trigger3 = stateno != 610

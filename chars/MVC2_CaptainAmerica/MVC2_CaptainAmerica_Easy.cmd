...
[State -1, Throw]
type = ChangeState
value = ifelse(random < 400,800,830)
triggerall = var(59)
...
;triggerall =  -30 <= p2bodydist y <= 0+var(7)
triggerall = p2bodydist y = [-5,5]
triggerall = statetype != A
trigger1 = ctrl
trigger1 = random < 300
...
triggerall =  -120 <= p2bodydist y <= -20+var(7)
triggerall = statetype != A
trigger1 = ctrl
trigger1 = random < 400
...
triggerall = p2bodydist y = [-5,5]
;triggerall =  -90 <= p2bodydist y <= 0+var(7)
trigger1 = p2statetype != L && p2statetype != A
...
triggerall =  -90 <= p2bodydist y <= -70+var(7)
;triggerall = p2bodydist y = [-5,5]
trigger1 = p2movetype != A  && p2statetype != L;  && p2statetype != A
trigger1 = ctrl
trigger1 = random < 200
...
triggerall = Statetype != A
triggerall = p2bodydist X = [0,90]
triggerall =  -50 <= p2bodydist y <= 0+var(7)
;triggerall = p2bodydist y = [-5,5]
trigger1 = random < 300
trigger1 = p2movetype != A && p2statetype != L; && p2statetype != A
trigger1 = ctrl
...
triggerall = statetype != A
triggerall = p2bodydist X = [0,80]
;triggerall =  -40 <= p2bodydist y <= 0+var(7)
triggerall = p2bodydist y = [-5,5]
...
triggerall = var(59)
triggerall = statetype != A
triggerall = p2bodydist X = [0,80-30*var(57)]
...
triggerall =  -70 <= p2bodydist y <= -40 + var(7)
...
triggerall = var(59)
triggerall = statetype != A
triggerall = p2bodydist X = [0,140 - 20*(var(57))]
;triggerall = p2bodydist y = [-5,5]
triggerall =  -100 <= p2bodydist y <= -35+var(7)
...
;---------------------------------------------------------------------------
[State -1,  Shield Slash Forward]
type = ChangeState
value = 1450
triggerall = var(59) && (stateno != [7720,7721]) && !var(57) && !NumHelper(21450)
triggerall = statetype != A
...
;---------------------------------------------------------------------------
[State -1,  Shield Slash Forward Low]
type = ChangeState
value = 1460
triggerall = var(59) && (stateno != [7720,7721]) && !var(57) && !NumHelper(21450)
triggerall = statetype != A
...
triggerall = p2bodydist Y/p2bodydist X = [-1.2,-0.7]
;triggerall =  -40 <= p2bodydist y <= -40+var(7)
triggerall = random < 100
trigger1 = ctrl
trigger2 = var(17) = 3
...
;---------------------------------------------------------------------------
[State -1,  Shield Slash Downward]
type = ChangeState
value = 1451
triggerall = var(59) && !var(57) && !NumHelper(21450)
triggerall = statetype = A
;triggerall = p2statetype != L; && enemynear,vel y >= 0
triggerall = p2bodydist X = [90,320]
triggerall = p2bodydist Y/p2bodydist X = [0.5,1]
;triggerall =  -70 <= p2bodydist y <= -70+var(7)
triggerall = random < 100
trigger1 = ctrl
trigger2 = var(17) = 3
...
;---------------------------------------------------------------------------
[State -1,  Shield Slash Up Forward]
type = ChangeState
value = 1471
triggerall = var(59) && !var(57) && !NumHelper(21450)
triggerall = statetype = A
...
;---------------------------------------------------------------------------
[State -1,  Charging Star]
type = ChangeState
value = 1480+10*(p2bodydist x = [90,150]) + 20*(p2bodydist x = [151,340])
triggerall = var(59) && (stateno != [7720,7721])
triggerall = statetype != A
triggerall = p2statetype != L && enemynear,vel y >= 0
triggerall = p2bodydist X = [80,320]
;triggerall = p2bodydist Y = [-120,120]
triggerall =  -40 <= p2bodydist y <= -40+var(7)
triggerall = random < 100
trigger1 = ctrl
...
triggerall = p2statetype != L; && enemynear,vel y >= 0
triggerall = p2bodydist X = [0,90]
triggerall = p2bodydist Y = [-270,-80]
;triggerall =  -40 <= p2bodydist y <= -40+var(7)
triggerall = random < 100
trigger1 = ctrl
trigger2 = var(17) = 3
...
triggerall = statetype != A
triggerall = p2statetype != L; && enemynear,vel y >= 0
triggerall = p2bodydist X = [50,170]
triggerall = p2bodydist Y = [-270,-80]
;triggerall =  -40 <= p2bodydist y <= -40+var(7)
triggerall = random < 100
trigger1 = ctrl
...
triggerall = p2statetype != L; && enemynear,vel y >= 0
triggerall = p2bodydist X = [70,320]
triggerall = p2bodydist Y = [-320,-80]
triggerall = p2bodydist y/p2bodydist x = [-1.2,-0.8]
;triggerall =  -40 <= p2bodydist y <= -40+var(7)
triggerall = random < 100
trigger1 = ctrl
trigger2 = var(17) = 3
...
triggerall = p2bodydist Y = [-320,5]
;triggerall =  -40 <= p2bodydist y <= -40+var(7)
triggerall = random < 50 + 50*(enemynear,movetype = A)
trigger1 = ctrl
trigger2 = var(17) = 3
trigger3 = var(9)
...
triggerall = statetype != A
triggerall = p2bodydist X = [90,320]
;triggerall = p2bodydist y = [-340,340]
triggerall =  -40 <= p2bodydist y <= 40+var(7)
triggerall = random < 50+100*(MoveHit > 0)
triggerall = p2statetype != L && p2stateno != 5120
trigger1 = ctrl
...
triggerall = var(59)
triggerall = p2bodydist X = [0,50]
triggerall = (var(8) = [-45,15]) && var(29) || (-65 <= p2bodydist y <= -15+var(7)) && !var(29)
trigger1 = statetype = A && ctrl
trigger1 = random < 400
...
triggerall = var(59)
triggerall = p2bodydist X = [0,50]
triggerall = (var(8) = [-45,25]) && var(29) || (-100 <= p2bodydist y <= -80+var(7)) && !var(29)
...
triggerall = (var(8) = [-45,15]) && var(29) || (-140 <= p2bodydist y <= -20+var(7)) && !var(29)
trigger1 = statetype = A && ctrl && random < 300
...
triggerall = var(59)
triggerall = p2bodydist X = [0,50]
triggerall = (var(8) = [-45,25]) && var(29) || (-62 <= p2bodydist y <= -32+var(7)) && !var(29)
...
triggerall = p2bodydist X = [0,50+ 50*(var(29) = 0)]
triggerall = (var(8) = [-45,25]) && var(29) || (-150 <= p2bodydist y <= 20+var(7)) && !var(29)
...
value = 620
triggerall = var(59) && var(57)
triggerall = p2bodydist X = [0,50+ 10*(var(29) = 0)]
triggerall = (var(8) = [-45,25]) && var(29) || (-70 <= p2bodydist y <= -50+var(7)) && !var(29)
;trigger1 =  -30 <= p2bodydist y <= -30+var(7)
trigger1 = statetype = A && ctrl && random < 100
trigger2 = var(17) = 5 && random < 200
trigger3 = var(17) = 6 && random < 300
...
triggerall = var(59)
triggerall = p2bodydist X = [0,50 + 30*(var(29) = 0)]
triggerall = (var(8) = [-45,25]) && var(29) || (-90 <= p2bodydist y <= -70+var(7)) && !var(29)
trigger1 = statetype = A && ctrl && random < 100
trigger2 = var(17) = 5 && random < 200
trigger3 = var(17) = 6 && random < 300
trigger4 = var(17) = 7 && var(21) = var(36)
trigger4 = stateno != 721


;---------------------------------------------------------------------------
[State -1, Air Strong Kick 3]
type = ChangeState
value = 722
triggerall = var(59)
triggerall = p2bodydist X = [0,50 + 10*(var(29) = 0)]
triggerall = (var(8) = [-45,25]) && var(29) || (-50 <= p2bodydist y <= -10+var(7)) && !var(29)
trigger1 = statetype = A && ctrl && random < 100
trigger2 = var(17) = 5 && random < 200
trigger3 = var(17) = 6 && random < 300
trigger4 = var(17) = 7 && var(21) = var(36)
trigger4 = stateno != 722
...
value = 3000
triggerall = !var(59)
triggerall = command = "Hyper Charging Star"
triggerall = power >= 1000
triggerall = statetype != A
trigger1 = ctrl
trigger2 = var(51)
...
value = 3040
triggerall = !var(59)
triggerall = command = "Hyper Stars & Stripes"
triggerall = power >= 1000
triggerall = statetype != A
trigger1 = ctrl
trigger2 = var(51)
...
value = 3400
triggerall = !var(59)
triggerall = command = "Final Justice"
triggerall = power >= 1000
triggerall = statetype != A
trigger1 = ctrl
trigger2 = var(51)
...
;---------------------------------------------------------------------------
[State -1,  Shield Slash]
type = ChangeState
value = 1450 + (StateType = A)
triggerall = !var(59) && !var(57) && !NumHelper(21450)
...
trigger1 = ctrl
trigger2 = var(17) = 1
trigger3 = var(17) = 2 && var(20) = var(36) + (stateno = 311)
trigger3 = stateno != 510 && stateno != 310

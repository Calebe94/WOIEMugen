...
trigger1 = enemynear, anim = 5300 && p2bodydist X > 120 && random = [20,100]
trigger2 = enemynear, numproj = 0 && enemynear, movetype != A && random <= 100

; castagne
[State -1, Bat-castagne]
type = ChangeState
value = 3200
triggerall = power >= 1000 && var(59) && ctrl
...
trigger1 = Random <= 150 && (statetype = S) && (var(59)=1)
trigger1 = ctrl = 1
...
triggerall = command = "qcb_x"&&P2Stateno !=100000
...
value = 1510
triggerall = (StateType != A) && (MoveType != H) && !Var(59)
triggerall = (command = "qcf_c") && (!IsHelper); && numproj = 0
trigger1 =  (ctrl = 1)
...
value = 1020
triggerall = (StateType != A) && (MoveType != H) && !Var(59)
triggerall = (ctrl = 1) && (!IsHelper) && numproj = 0  && enemynear,anim!=5300
...
type = ChangeState
value = 4000
triggerall = command = "Dragon_Cannon" && power >= 1000
trigger1 = ctrl
trigger1 = statetype = S

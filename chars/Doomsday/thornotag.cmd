...
type = ChangeState
triggerall = Var(59)>=1&& StateType != A && Ctrl 
trigger1 = P2bodydist X >= 170 && P2StateType != A && Random <= 200
value = 1000
persistent = 0
...
type = ChangeState
triggerall = Var(59)>=1&& StateType != A  
trigger1 = P2bodydist X >=150 && Ctrl && Random <= 80
...
trigger1 = StateNo = 210 && movecontact && Random <= 20
trigger2 = StateNo = 240 && movecontact && Random <= 20
...
triggerall = Var(59)>=1 && StateType != A && power >= 1000
triggerall = Random <= 50 
trigger1 = StateNo=1100 && Random <= 20 && time >=30 
trigger2 = P2bodydist X >= 150 && Random <= 500 && Ctrl 
...
type = ChangeState
triggerall = Var(59)>=1 && StateType != A && p2bodydist X <= 65 && power >= 1000 
trigger1 = Random <= 50 && Ctrl 
trigger2 = StateNo=220 || StateNo=250 && movecontact && Random <= 70 
